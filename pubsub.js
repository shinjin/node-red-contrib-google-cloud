...
module.exports = function(RED) {
        ...
        function OnTopic(error, topic) {
            if (error == null) {
                ...
                if (config.subscription && config.subscription != "") {
                    ...
                    config.subscription = "nodered-default-" + node.id;
                }
                const sub = topic.subscription(config.subscription);
                sub.get(options, OnSubscribed);
    ...
    function GoogleCloudPubSubOutNode(config) {
        ...
        function OnInput(message) {
            ...
            state.topic.publishJSON(message, {}, OnPublished);
            if (state.pending == 0) {
